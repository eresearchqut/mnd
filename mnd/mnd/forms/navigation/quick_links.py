...
MIMSProductCache = make_link(
    "admin:mnd_mimsproductcache_changelist", _("MIMS Product cache")
)
MIMSCMICache = make_link(
    "admin:mnd_mimscmicache_changelist", _("MIMS CMI cache")
)
