...
from .views.private_health_fund import load_private_health_funds
...
urlpatterns = [
    ...
    re_path(r"^get_private_health_funds/$", load_private_health_funds, name="load_private_health_funds"),
